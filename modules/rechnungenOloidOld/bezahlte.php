...
if($order=="datum"){
	...
	$order="ORDER BY rech.betreff";
} else if($order=="betrag") {
	$order="ORDER BY betrag";
} else if($order=="id") {
	$order="ORDER BY rech.id";
} else if($order=="bezahlt") {
	$order="ORDER BY rech.bezahlt";
} else {
